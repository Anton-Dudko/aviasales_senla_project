...
public final class ExceptionMessageConstants {
    ...
    public static final String DATE_IS_NULL = "The date is null.";
    public static final String NOT_VALID_LANGUAGE = "The language should be RU or EN or not to be at all (default is EN)";
    public static final String NOT_VALID_ROLE = "The role should be ROLE_USER or ROLE_ADMIN or not to be at all (default is ROLE_USER). The ROLE_ADMIN is only for testing, it shouldn't be able in future";
