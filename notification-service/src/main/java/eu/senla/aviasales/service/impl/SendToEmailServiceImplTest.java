...
//@Slf4j
//@Service
public class SendToEmailServiceImplTest {
}
...
//    public static final int COUNT_EXCEPTION = 2;
//
//    @Override
...
//        while (tempCount < COUNT_EXCEPTION) {
//            log.warn("... COUNT_EXCEPTION {}", tempCount);
//            throw new RuntimeException("SOME EXCEPTION FOR TESTING");
//        }
//
